...
class SalaryForm(forms.ModelForm):
    ...
    class Meta:
        model = Salary
        fields = ('employee', 'basic_percentage','basic_amount','hra_amount', 'hra_percentage', 'conveyance_allowance', 'special_allowance','bonus', 'proffessional_tax', 'income_tax', 'loss_of_pay', 'gross_earning', 'gross_deduction', 'net_salary','month_year')
        ...
        widgets = {
                ...
                'bonus': forms.NumberInput(attrs={'class': 'form-control','placeholder':'bonus'}),
...
class Salary_History_Form(forms.ModelForm):
        ...
        class Meta:
                ...
                fields=('employee','date','basic_percentage','hra_percentage','conveyance_allowance','proffessional_tax','income_tax')
        ...
        def __init__(self, *args, **kwargs):
                company_id=kwargs.pop('company',False)
                super(Salary_History_Form, self).__init__(*args, **kwargs)
                if company_id:
                        self.fields['employee'] = forms.ModelChoiceField(queryset=Employee.objects.filter(company=company_id), widget=forms.Select(attrs={'class':'form-control'}))
