...
def employee_edit(request, pk):
    ...
    try:
        ...
        print('current',employee.profile_pic)
    if request.method == "POST":

        form = EmployeeForm(request.POST,request.FILES or None, instance=employee)
        ...
        if form.is_valid():
            ...
            employee = form.save()
            print('profile_pic',request.POST['profile_pic'])
